...
//Degiskeni instantiate et
    ...
    public void NullPointerException() {
        driver.get("http://www.techproeducation.com");//java.lang.NullPointerException
    }

    @Test
    public void NullPointerException2() {
   //     faker=new Faker();
        System.out.println("faker.name().fullName() = " + faker.name().fullName());//java.lang.NullPointerException
    }
}
