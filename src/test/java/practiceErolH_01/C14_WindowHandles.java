...
public class C14_WindowHandles extends TestBase {
    @Test
    public void test01() {
        ...
        //sayfalar arasi gecis bu sekilde de yapilabilir
        ...
        System.out.println("Açılan pencerelerin handle değerleri : "+windowHandles2);
        ...
        driver.close();
        //kalan sayfalar icinde ikinci sayfaya gecis icin
        driver.switchTo().window(windowHandles2.get(2));
