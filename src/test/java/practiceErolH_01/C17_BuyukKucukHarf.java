...
public class C17_BuyukKucukHarf extends TestBase {
    @Test
    public void name() {
        ...
        searchBox.sendKeys(Keys.SHIFT,"h",Keys.SHIFT,"e",Keys.SHIFT,"l",Keys.SHIFT,"l",Keys.SHIFT,"o",Keys.SHIFT,"o",Keys.SHIFT);
